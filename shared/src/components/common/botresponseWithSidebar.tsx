    ...
    >
      ...
      <div className="mt-auto">
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-700">
          <a
            className="flex justify-between items-center gap-x-3 py-2 px-3 text-sm text-slate-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
            href="#"
          >
            Sign in
            <svg
      ...
      <ul className="mt-16 space-y-5">
        ...
        <li className="max-w-4xl py-2 px-4 sm:px-6 lg:px-8 mx-auto flex gap-x-2 sm:gap-x-4">
          ...
          <div className="grow max-w-[90%] md:max-w-2xl w-full space-y-3">
            ...
            {/* End Card */}
            <pre className="mt-3 bg-[#1e293b] text-sm leading-7 text-slate-50 flex overflow-auto rounded-lg dark:border dark:border-gray-700">
              <code className="docs-prism flex-none min-w-full p-5">
            ...
            <div className="max-w-2xl flex gap-x-2 sm:gap-x-4">
              <div>
                <div className="text-end">
                  <button
                    type="button"
                    className="ms-1.5 py-2 px-3 inline-flex justify-center items-center gap-x-2 rounded-lg border border-blue-600 bg-white text-blue-600 align-middle hover:bg-blue-50 text-sm dark:bg-slate-900 dark:text-blue-500 dark:border-blue-500 dark:hover:text-blue-400 dark:hover:border-blue-400 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                  >
...
export default BotRsponseWithSidebar